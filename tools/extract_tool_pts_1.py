...
class ToolExtractor:
    ...
    def __init__(self, folder_name, csv_name):
        ...
        # self.lower_thresh_g = np.array([40, 55, 75], np.uint8)
        # self.upper_thresh_g = np.array([75, 255, 255], np.uint8)

        self.lower_thresh_g = np.array([52, 52, 82], np.uint8)
        self.upper_thresh_g = np.array([75, 239, 137], np.uint8)

        self.lower_thresh_r = np.array([130, 30, 69], np.uint8)  # [130, 150, 69] [130, 30, 69]
        self.upper_thresh_r = np.array([192, 255, 255], np.uint8)  # [180, 255, 255] [192, 255, 255]
